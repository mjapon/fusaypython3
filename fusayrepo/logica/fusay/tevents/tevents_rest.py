...
from fusayrepo.logica.fusay.tevents.tevents_dao import TFusayEventsDao
from fusayrepo.logica.fusay.tlugarcer.tlugarcer_dao import TFusayLugarEvDao
from fusayrepo.logica.fusay.ttiposcer.ttipocer_dao import TFusayTipEventDao
