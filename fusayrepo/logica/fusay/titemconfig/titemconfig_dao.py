...
class TItemConfigDao(BaseDao):
    ...
    def buscar_articulos(self, filtro, sec_id, tracod):
        ...
        sql = """
                select a.ic_id,
                       ...
                       a.tipic_id,
                       td.icdp_grabaiva,
                       case td.icdp_grabaiva when true then round(public.get_precio_venta_sin_iva(0.15,td.icdp_preciocompra),4) else icdp_preciocompra end as icdp_preciocompra, 
    ...
    def aux_get_detalles_ctacontable(self, colnamewhere, colvalue, coleq="=", singlerow=True):
        sql = """
